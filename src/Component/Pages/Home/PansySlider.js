            ...
            <Slider {...settings}>
                <div>
                    <div
                        ...
                        <div className="col-span-2 hidden md:block">
                            <p className="header slider-header">RIDES MADE BETTER</p>
                ...
                <div>
                    <div
                        ...
                        <div className="col-span-2 hidden md:block">
                            <p className="header slider-header">EXPRIENCE NEW RIDE</p>
                            <p cl="text-2xl">Believe in your cycle, It will lead your way. The best rides heppen on two wheels. Ride it like a pro it's not just a riding. It's a feeling. Ride and live today</p>
                            <Link to="/shop">
                ...
                <div>
                    <div
                        ...
                        <img className="col-span-2" src="https://i.ibb.co/7bwGPkz/Product10.jpg" alt="" />
                        <div className="col-span-2 hidden md:block">
                            <p className="header slider-header">LOVE EVERY RIDE</p>
                            <p cl="text-2xl">Believe in your cycle, It will lead your way. The best rides heppen on two wheels. Ride it like a pro it's not just a riding. It's a feeling. Ride and live today</p>
                            <Link to="/shop">
                ...
                <div>
                    <div
                        ...
                        <div className="col-span-2 hidden md:block">
                            <p className="header slider-header">A POPULATION FREE RIDE</p>
                            <p cl="text-2xl">Believe in your cycle, It will lead your way. The best rides heppen on two wheels. Ride it like a pro it's not just a riding. It's a feeling. Ride and live today</p>
                            <Link to="/shop">
                                <button className="button mt-6">buy now</button>
                            </Link>
