    ...
    return (
        <div className="grid grid-cols-2 bg-white gap-3">
            ...
            <div className="mt-8 text-2xl font-bold leading-10">
                ...
                <p>Vendor: <span className="text-xl font-semibold">Zinga</span></p>
                <p className="my-3">Type: <span className="text-xl font-semibold">Non Geared</span></p>
                <p>Availability: <span className="text-green-500 text-xl font-semibold">In stock!</span></p>
                <div>
